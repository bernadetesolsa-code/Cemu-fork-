...
object NativeSettings {
    ...
    @JvmStatic
    external fun getLimitToHalfFps(): Boolean

    @JvmStatic
    external fun setLimitToHalfFps(value: Boolean)

    @JvmStatic
    external fun getEmulationSpeedPercent(): Int

    @JvmStatic
    external fun setEmulationSpeedPercent(value: Int)
