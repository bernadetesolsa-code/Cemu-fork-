...
uint32 ActiveSettings::GetGameSpeedPercent()
{
	return s_game_speed_percent;
}

void ActiveSettings::SetGameSpeedPercent(uint32 speedPercent)
{
	s_game_speed_percent = speedPercent;
}
