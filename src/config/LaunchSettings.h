...
public:
	...
	// 0 (default) = auto-detect based on core count, >0 = force a specific number of parallel recompiler worker threads
	static sint32 GetPPCRecCompilerThreadCount() { return s_ppcRec_compilerThreadCount; };
...
private:
	...
	inline static sint32 s_ppcRec_compilerThreadCount{};
